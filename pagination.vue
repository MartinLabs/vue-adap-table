...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;return _h('ul',{staticClass:"pagination"},[_h('li',[_h('a',{on:{"click":function($event){_vm.store.previousPage()}}},["«"])])," ",_vm._l((_vm.store.pageCount+1),function(n){return _h('li',{class:{ active: n == _vm.store.currentPage+1 },on:{"click":function($event){_vm.store.setCurrentPage(n-1)}}},[_h('a',[_vm._s(n)])])})," ",_h('li',[_h('a',{on:{"click":function($event){_vm.store.nextPage()}}},["»"])])])}
