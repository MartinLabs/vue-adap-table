...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;return _h('th',{on:{"click":function($event){_vm.store.setOrder(_vm.name)}}},[_vm._t("default")," ",_h('span',{class:{ glyphicon: _vm.store.orderBy === _vm.name, 'glyphicon-chevron-up': _vm.store.orderBy === _vm.name && _vm.store.asc, 'glyphicon-chevron-down': _vm.store.orderBy === _vm.name && !_vm.store.asc }})])}
